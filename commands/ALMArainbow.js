...
module.exports.run = async (bot,message,args) => {
        ...
        let spaminterval = 10
            if (guilds.r1spam) {
                if (new Date().getTime() - guilds.r1spam < spaminterval*1000) {
                    ...
                    console.log('=> '+userlog + ' has called [ RB ] command SPAM')
                    ...
                    return;
                        ...
                        setTimeout(function(){
                            ...
                            console.log('=> '+userlog + ' has called [ RB ] command')
                            pin = 1;
                        },500)
                    }
            }
    ...
    function Rcolor(mod,ColorCode)
    {
            ...
            //console.log('mod: '+mod+'length: '+ColorCode.length)
            newrole = gRole.edit({
